...
jQuery.fn.pagination = function(maxentries, opts){
	...
	return this.each(function() {
		...
		function drawLinks() {
			...
			var pagetext = '<input id="pagevalue" size="1" style="vertical-align: top;width: 34px;" value="'+(current_page+1)+'"type="text">';
			var toPage='<a id="search" href="javascript:void(0);">跳转</a>';
