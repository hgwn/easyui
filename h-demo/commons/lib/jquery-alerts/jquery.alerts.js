...
(function($) {
		...
		_show: function(title, msg, value, type, callback) {
			...
			$("BODY").append(
			  '<div id="popup_container">' +
			    ...
			    '<a id="popup_hide" class="h-dialog_close"  onclick="$.alerts._hide();">关闭</a>'+
	...
	jAlert={
		info:function(message, title,type,callback){
			$.alerts.alert(message, title,'info', callback);
		},
		warn:function(message, title,type,callback){
			$.alerts.alert(message, title, 'warn', callback);
		},
		error:function(message, title,type,callback){
			$.alerts.alert(message, title, 'error', callback);
		},
		success:function(message, title,type,callback){
			$.alerts.alert(message, title, 'success', callback);
		}
	};
